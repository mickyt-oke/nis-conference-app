...
export default function SpeakersPage() {
  ...
  const speakers = [
    {
      id: 1,
      name: "KN Nandap, pcc, mmis, fsmn",
      title: "Comptroller General",
      organization: "Nigeria Immigration Service",
      bio: "She has over 35 years of experience in Immigration policy and border security. She holds a PhD in International Relations and has led numerous strategic initiatives.",
      email: "cgis@immigration.gov.ng",
  ...
  const expertiseAreas = Array.from(new Set(speakers.flatMap((speaker) => speaker.expertise)))
  const tabs = ["all", ...expertiseAreas]
