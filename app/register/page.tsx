...
import { Users, Mic, Shield, Calendar, DollarSign, Mail, CheckCircle, AlertCircle, Loader2 } from "lucide-react"
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="font-semibold text-lg mb-2">NIS Team Member</h3>
                  <p className="text-sm text-gray-600 mb-4">Internal staff registration with supervisor approval</p>
